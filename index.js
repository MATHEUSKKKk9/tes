...
client.on("ready", () => {
    ...
    let channel = client.channels.cache.get(config.get(`voice_channel`));
...
👻  | Sistema de vendas automáticas`);
    client.user.setActivity(`${config.get(`status`)}`, { type: "STREAMING", url: config.get(`twitch_link`) });
});
...
\`\`\`
**<a:planeta:1121658488741961759> | Nome:** __${db.get(`${interaction.customId}.nome`)}__
**<:MoneyLost7:1121658471666958406> | Preço:** __${db.get(`${interaction.customId}.preco`)}__
**<:Caixa:1121658402448343070> | Estoque:** __${db.get(`${interaction.customId}.conta`).length}__`)
        ...
        interaction.guild.channels.create(`🛒・-${interaction.user.username}`, {
          ...
          permissionOverwrites: [
           ...
           const embedss = new Discord.MessageEmbed()
             ...
             .addField(`<<a:planeta:1121658488741961759> | Nome:`, `${eprod.nome}`)
             .addField(`<:Caixa:1121658402448343070> | Quantidade:`, `${quantidade1}`)
                 ...
                 if (intera.customId === "removeboton") {
                   ...
                   if (intera.customId === "comprarboton") {
                     ...
                     const embedss = new Discord.MessageEmbed()
                       ...
                       .addField(`<:MoneyLost7:1121658471666958406> | Preço Atual:`, `${precoalt}`) 
                       .setColor(config.get(`color`))
                       .setThumbnail(client.user.displayAvatarURL())
                           ...
                           intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: true });
                            msg.channel.send("❓ | Qual o cupom?").then(mensagem => {
                             ...
                             collector.on("collect", cupom => {
                               ...
                               if(`${cupom}` === `${dbc.get(`${cupom}.idcupom`)}`) {
                                 cupom.delete()
                                 mensagem.edit("<a:carregando_2:1121658406734934121> | Cupom adicionado")
                                  intera.channel.permissionOverwrites.edit(intera.user.id, { SEND_MESSAGES: false });
                                  ...
                                  const vendadel = setTimeout(function () {
                                   ...
                                   const canalif1 = client.channels.cache.get(config.canallogs);
                                     ...
                                     if (a < quantidade1) {
                                       ...
                                       msg.channel.send("<a:carregando_2:1121658406734934121> | Pagamento reembolsado")
                                       msg.channel.send(`<a:carregando_2:1121658406734934121> | ID Da compra: ${data_id}`)
                                           ...
                                           const removed = a.splice(0, Number(quantidade1));
                                            db.set(`${severi}.conta`, a);
                                             const embedentrega = new Discord.MessageEmbed()
                                               ...
                                               .setDescription(`**🪪 | Produtos:** \n  \`\`\` 1º| ${removed.join("\n")}\`\`\`\n**🪪 | Id da Compra:** ${data_id}\n\n**⭐ | Avalie a nossa loja #avaliações** `)
                                               .setColor(config.get(`color`))
                                               .setThumbnail(client.user.displayAvatarURL())
                                             interaction.user.send({ embeds: [embedentrega] })
                                              db3.set(`${data_id}.status`, `Concluido`)
                                              msg.channel.send("<a:carregando_2:1121658406734934121> | Pagamento aprovado verifique a sua dm!")
                                              msg.channel.send(`<a:carregando_2:1121658406734934121> | ID Da compra: ||${data_id}||`)
                                              msg.channel.send("<a:carregando_2:1121658406734934121> | Carrinho fechara em 3 minutos")
                                             ...
                                             interacaoavaliar.on("collect", async (interaction) => {
                                               ...
                                               if (interaction.isButton()) {
                                                 ...
                                                 for (let i = 0; i != estrelas; i++) {
                                                   ...
                                                   interaction.deferUpdate()               
                                                   embed.reply("<a:carregando_2:1121658406734934121> | Obrigado pela avaliação!").then(msg => {
                                                     ...
                                                     .addField(`<:Caixa:1121658402448343070> | Quantidade:`, `${quantidade1}x`)
                                               ...
                                               const message2 = await canalif.send({ embeds: [new Discord.MessageEmbed()
                                                 ...
                                                 .addField(`🛒 | Produto:`, `${eprod.nome}`)
                                                 .addField(`<:Caixa:1121658402448343070> | Quantidade:`, `${quantidade1}x`)
                                                 .addField(`<:MoneyLost7:1121658471666958406> | Preço:`, `${precoalt}`)
                                                 .addField(`🪪 | Id da compra:`, `${data_id}`)
...
\`\`\``)
  ...
  client.on("messageCreate", message => {
    ...
    .setColor("BLACK")
    .setDescription(`**💻 | Olá <@${message.author.id}>, sou um bot de vendas automáticas e o meu prefixo é \` ${config.get(`prefix`)} \`veja a minha lista de comandos com \`${config.get(`prefix`)}ajuda\`.**`)
